...
public class TestStyleFilterView extends NXRuntimeTestCase {
    ...
    public void setUp() throws Exception {
        ...
        formatType = (FormatType) typeRegistry.lookup(TypeFamily.FORMAT, "style");
    ...
    public void testFilter2() {
        ...
        filter.process(info, false);
        assertEquals("<div style=\"color:red;\" class=\"nxStyle1\">content</div>", info.getMarkup());
    }
    ...
    public void testFilter3() {
        ...
        filter.process(info, false);
        assertEquals("<div class=\"test nxStyle1\">content</div>", info.getMarkup());
    }
    ...
    public void testFilter6() {
        ...
        filter.process(info, false);
        assertEquals("<div\r class=\"nxStyle1\">content\r</div>", info.getMarkup());
    }
    ...
    public void testFilter7() {
        ...
        filter.process(info, false);
        assertEquals("<div class=\"nxStyle1\"><div style=\"color:red\">content</div></div>", info.getMarkup());
    }
    ...
    public void testFilter8() {
        ...
        filter.process(info, false);
        assertEquals("<div style=\"color:red\" class=\"nxStyle1\"><div style=\"color:red\">content</div></div>",
                info.getMarkup());
    }
    ...
    public void testFilter9() {
        ...
        filter.process(info, false);
        assertEquals("<img src=\"/logo.png\" class=\"nxStyle1\" />", info.getMarkup());
    }
    ...
    public void testStyleInheritance() throws ThemeException {
        ...
        filter.process(info, false);
        assertEquals("<div class=\"nxStyle2 nxStyle1\"></div>", info.getMarkup());
    }
